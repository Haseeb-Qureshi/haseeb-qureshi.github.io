...
![Screenshot of a TechCrunch headline reporting on the release of the Plasma scaling paper](https://miro.medium.com/max/783/0*pmSpCD5bi_0ER4MR)
...
![Photo of Vitalik Buterin and Joseph Poon presenting Plasma on stage at a San Francisco meetup](https://miro.medium.com/max/1600/0*7XuvIcVTIXPjoolQ)
...
![Social media post from the 2017 wave of Ethereum community excitement around Plasma](https://miro.medium.com/max/794/1*S4LgcG7_5HiUJ84wL4FFXQ.png)
...
![Diagram of the Plasma tree of blockchains: child chains branching in a hierarchy from the Ethereum root chain](https://miro.medium.com/max/638/0*ljhRM5ybxm635x4Y)
...
![Diagram of two-way peg transfers between a main chain and a sidechain, using the Liquid network as an example](https://miro.medium.com/max/971/0*P5GqjhzTyRI4R_kk)
...
![Chart of Ethereum state storage growing steadily over time](https://miro.medium.com/max/700/0*Vioh2FqkxrNU1gAj)
...
![Screenshot of a claim that Plasma Cash could reach hundreds of thousands of transactions per second](https://miro.medium.com/max/670/1*ZsQGreDRZs3hZBNJxoMLIw.png)
...
![Illustration of zk-Rollup bundling sidechain transactions and posting their data to Ethereum](https://miro.medium.com/max/960/0*PHbHLyMPdNXwiwpX)

![Screenshot of Vitalik Buterin's zk-Rollup post on the Ethereum research forum](https://miro.medium.com/max/721/0*jwqlaAzuHVdFNDti)
...
![Diagram of a zk-Rollup: a relayer bundles user transactions and posts a SNARK proof to a contract on Ethereum](https://miro.medium.com/max/527/1*vZT8ezybGijoLGVdPa-75w.png)
...
![Illustration of Ethereum layer-2 scaling research converging from Plasma toward rollup designs](https://miro.medium.com/max/1182/0*WF692AxocXAhh7m4)
